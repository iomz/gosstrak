...
func TestMakeGIAI96(t *testing.T) {
	...
	tests := []struct {
		...
		{"3474257BF40000000000162E", args{true, "3", "0614141", "5678"}, []byte{}, "001101000111010000100101011110111111010000000000000000000000000000000000000000000001011000101110", "urn:epc:pat:giai-96:3.0614141.5678", false},
		{"3474257BF40000000000162E", args{true, "3", "0614141", ""}, []byte{}, "00110100011101000010010101111011111101", "urn:epc:pat:giai-96:3.0614141", false},
		{"3474257BF40000000000162E", args{true, "3", "", ""}, []byte{}, "00110100011", "urn:epc:pat:giai-96:3", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
