...
func TestMakeGIAI96(t *testing.T) {
	...
	tests := []struct {
		...
		{"3474257BF40000000000162E: binary id", args{false, "3", "0614141", "5678"}, []byte{52, 116, 37, 123, 244, 0, 0, 0, 0, 0, 22, 46}, "", "", false},
		{"3474257BF40000000000162E: tag pat full", args{true, "3", "0614141", "5678"}, []byte{}, "001101000111010000100101011110111111010000000000000000000000000000000000000000000001011000101110", "urn:epc:pat:giai-96:3.0614141.5678", false},
		{"3474257BF40000000000162E: tag pat up to cp", args{true, "3", "0614141", ""}, []byte{}, "00110100011101000010010101111011111101", "urn:epc:pat:giai-96:3.0614141", false},
		{"3474257BF40000000000162E: tag pat only filter value", args{true, "3", "", ""}, []byte{}, "00110100011", "urn:epc:pat:giai-96:3", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestMakeGRAI96(t *testing.T) {
	...
	tests := []struct {
		...
		{"3374257BF40C0E400000162E", args{true, "3", "0614141", "12345", "5678"}, []byte{}, "001100110111010000100101011110111111010000001100000011100100000000000000000000000001011000101110", "urn:epc:pat:grai-96:3.0614141.12345.5678", false},
		{"3374257BF40C0E400000162E", args{true, "3", "0614141", "12345", ""}, []byte{}, "0011001101110100001001010111101111110100000011000000111001", "urn:epc:pat:grai-96:3.0614141.12345", false},
		{"3374257BF40C0E400000162E", args{true, "3", "0614141", "", ""}, []byte{}, "00110011011101000010010101111011111101", "urn:epc:pat:grai-96:3.0614141", false},
		{"3374257BF40C0E400000162E", args{true, "3", "", "", ""}, []byte{}, "00110011011", "urn:epc:pat:grai-96:3", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestMakeSGTIN96(t *testing.T) {
	...
	tests := []struct {
		...
		{"3074257BF7194E4000001A85", args{true, "3", "0614141", "812345", "6789"}, []byte{}, "001100000111010000100101011110111111011100011001010011100100000000000000000000000001101010000101", "urn:epc:pat:sgtin-96:3.0614141.812345.6789", false},
		{"3074257BF7194E4000001A85", args{true, "3", "0614141", "812345", ""}, []byte{}, "0011000001110100001001010111101111110111000110010100111001", "urn:epc:pat:sgtin-96:3.0614141.812345", false},
		{"3074257BF7194E4000001A85", args{true, "3", "0614141", "", ""}, []byte{}, "00110000011101000010010101111011111101", "urn:epc:pat:sgtin-96:3.0614141", false},
		{"3074257BF7194E4000001A85", args{true, "3", "", "", ""}, []byte{}, "00110000011", "urn:epc:pat:sgtin-96:3", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestMakeSSCC96(t *testing.T) {
	...
	tests := []struct {
		...
		{"3174257BF4499602D2000000", args{true, "3", "0614141", "1234567890"}, []byte{}, "001100010111010000100101011110111111010001001001100101100000001011010010", "urn:epc:pat:sscc-96:3.0614141.1234567890", false},
		{"3174257BF4499602D2000000", args{true, "3", "0614141", ""}, []byte{}, "00110001011101000010010101111011111101", "urn:epc:pat:sscc-96:3.0614141", false},
		{"3174257BF4499602D2000000", args{true, "3", "", ""}, []byte{}, "00110001011", "urn:epc:pat:sscc-96:3", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
